...
const languages = {
  ...
  Italian: {
    ...
    whyItMatters: "Agricoltura, lavoro, benessere familiare e infrastruttura comunitaria in un unico ecosistema vivo.",
    guest: "Ospite",
    customer: "Cliente",
    grower: "Coltivatore",
    ...
    welcomeLine: "Una piattaforma agricola accogliente, visiva e basata sui ruoli per la comunità.",
    ecosystem: "Questa demo mostra come Bronson Family Farm e Farm & Family Alliance possano guidare visitatori, coltivatori, giovani, volontari e team operativi attraverso un sistema reale.",
    startJourney: "Avvia Demo",
    ...
    hospitality: "Agriturismo e Ospitalità",
    ...
    askPlaceholder: "Chiedi informazioni su semina, volontari, ritiro, sicurezza, ricette o eventi…",
  ...
  Hebrew: {
    ...
    whyItMatters: "חקלאות, תעסוקה, רווחת המשפחה ותשתית קהילתית במערכת חיה אחת.",
    guest: "אורח",
    customer: "לקוח",
    grower: "מגדל",
    supervisor: "מפקח",
    ...
    welcomeLine: "פלטפורמת חווה ידידותית, חזותית ומבוססת תפקידים עבור הקהילה.",
    ecosystem: "הדגמה זו מראה כיצד Bronson Family Farm ו-Farm & Family Alliance יכולות להדריך מבקרים, מגדלים, צעירים, מתנדבים וצוותי תפעול דרך מערכת עובדת אמיתית.",
    startJourney: "התחל הדגמה",
    ...
    askPlaceholder: "שאלו על שתילה, מתנדבים, איסוף, בטיחות, מתכונים או אירועים…",
    calmMode: "מצב רגוע",
